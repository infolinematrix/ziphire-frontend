...
import ProfileFormBasic from '../components/ProfileFormBasic'

interface Props { }

const CandidateProfile: NextPage<Props> = ({ }) => {
    return (
            ...
            <div className="flex flex-1 gap-4">
                ...
                <main className="w-full overflow-y-auto">
                    <ScrollArea className="h-screen">
                        <section>
                            <div className='my-5 bg-background rounded-2xl p-4'>
                            <h1 className="text-lg font-semibold m0-4">Job Profile</h1>
                            <p className="text-gray-700 dark:text-gray-300 text-sm">
                                This is the candidate profile page where you can view and edit your profile information.
                            </p>
                            <div className="mt-4">
                                <ProfileFormBasic />
                            </div>
